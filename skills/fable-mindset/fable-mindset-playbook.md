...
| ferramentas por turno (média) | 6.57 | 7.98 | o Fable foi mais ECONÔMICO: menos ferramentas por turno (6.57 vs 7.98 do claude-opus-4-8) e ainda assim resolvia — densidade, não thrashing. |
| read-antes-de-edit | 34% | 37% | boa prática (heurística conservadora). |
| teste-depois-de-edit | 0% | 2% | boa prática (amostra ruidosa). |
...
2. **Seja econômico com ferramentas — densidade, não agitação.** Medido:
   o Fable foi mais ECONÔMICO: menos ferramentas por turno (6.57 vs 7.98 do claude-opus-4-8) e ainda assim resolvia — densidade, não thrashing. A meta não é "fazer mais chamadas"; é cada chamada ter propósito.
...
3. **Leia antes de editar — sempre.** Nunca edite um arquivo que você não leu
   neste contexto. (Os dois modelos ficaram modestos aqui — ~34%/37% —
